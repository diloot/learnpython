 ...
 */
final class Version20190104113157 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, parent_id INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, link VARCHAR(255) NOT NULL, duration SMALLINT NOT NULL, date DATETIME NOT NULL, price NUMERIC(6, 2) NOT NULL, content LONGTEXT NOT NULL, post_type VARCHAR(100) NOT NULL, status VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_5A8A6C8D3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
